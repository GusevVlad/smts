#!/bin/bash
# ext-client-receive.sh - External client receiving messages from EXT SMTS
...
# Configuration
MESSAGE_API_URL="${MESSAGE_API_EXT:-http://localhost:19081}"
TOPIC="${TOPIC_MONTERRA:-test.monterra.event}"
COUNT="${1:-1}"  # Default to 1 message if not specified

echo "Receiving messages from EXT SMTS..."
